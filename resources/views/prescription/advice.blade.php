...
@section('content')
    ...
    <div class="container-fluid">
        <div class="card mb-4 shadow">
            ...
            <div class="card-header py-3 bg-abasas-dark">
                <nav class="navbar navbar-dark ">
                    <a class="navbar-brand"> Add Advice</a>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-header py-3 bg-abasas-dark">
                <nav class="navbar navbar-dark ">
                    <a class="navbar-brand"> Advices List</a>
                    ...
                    <table class="table table-striped table-bordered" id="dataTable1" width="100%" cellspacing="0">
                        ...
                        @foreach ($advices as $advice)
                            ...
                            <tr class="data-row">
                                ...
                                <td class="  word-break name">{{$advice->name}}</td>
                                <td class=" word-break description ">{{$advice->description}}</td>


                                <td class="align-middle">
                                    <button type="button" class="btn btn-success" id="advice-edit-item" data-item-id={{$id}}> <i class="fa fa-edit" aria-hidden="false"> </i></button>


                                    <form method="POST" action="{{ route('advices.destroy', $advice->id   )}} " id="delete-form-{{ $advice->id }}" style="display:none; ">
                                        {{csrf_field() }}
                                        {{ method_field("delete") }}
                                    </form>
                                    ...
                                    <button onclick="if(confirm('are you sure to delete this')){
                                        document.getElementById('delete-form-{{ $advice->id }}').submit();
                                        }
                                        else{
    ...
    <!-- Attachment Modal -->
    <div class="modal fade" id="advice-edit-modal" tabindex="-1" role="dialog" aria-labelledby="edit-modal-label" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-dark" id="edit-modal-label ">Edit Advice</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body" id="attachment-body-content">
                    <form id="advice-edit-form" class="form-horizontal" method="POST" action="">
                    @csrf
                        @method('put')
