...
<input type="text"  id="divisions_list_api" value="{{route('divisions_list_api')}}" hidden >
<input type="text"  id="district_list_api" value="{{route('district_list_api')}}" hidden >
<input type="text"  id="upazilla_list_api" value="{{route('upazilla_list_api')}}" hidden >
...
<input type="text"  id="office_list_api" value="{{route('office_list_api')}}" hidden >
