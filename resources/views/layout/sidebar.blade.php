...
<ul class="navbar-nav    sidebar sidebar-dark accordion" id="accordionSidebar">
  ...
  <div class="card  bg-abasas-dark mb-2">
    ...
    <li class="nav-item">
      ...
      <div id="collapsePrescription" class="collapse" aria-labelledby="headingPrescription" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{ route('prescriptions.index') }}">Create New</a>
    ...
    <div class="card  bg-abasas-dark mb-2">
        ...
        <!--Category  Collapse Menu -->
        <li class="nav-item">
            <a class="nav-link collapsed  p-3 " href="#" data-toggle="collapse" data-target="#collapseStaff"
        ...
        <!--Category  Collapse Menu -->
        <li class="nav-item">
            <a class="nav-link collapsed  p-3 " href="#" data-toggle="collapse" data-target="#collapseMedichine"
                aria-expanded="true" aria-controls="collapseMedichine">
                <i class="fas fa-fw fa-cog"></i>
                <span>Medichine</span>
            </a>
            <div id="collapseMedichine" class="collapse" aria-labelledby="headingMedichine"
        ...
        <!--prescription  Collapse Menu -->
        <li class="nav-item">
            <a class="nav-link collapsed  p-3 " href="#" data-toggle="collapse" data-target="#collapsePrescription"
                aria-expanded="true" aria-controls="collapsePrescription">
                <i class="fas fa-fw fa-cog"></i>
                <span>Prescription</span>
            </a>
            <div id="collapsePrescription" class="collapse" aria-labelledby="headingPrescription"
                data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
